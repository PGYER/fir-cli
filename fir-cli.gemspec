...
Gem::Specification.new do |spec|
  ...
  ## 更新记录 
  - (1.6.6) 调整了超时时间,以缓解海外用户连接时候容易超时的问题, 若需要改变超时时间, 可使用 ENV['FIR_TIMEOUT']=5 fir publish 进行修改, 单位为秒
  - (1.6.6) publish 指令增加 -r 参数, 会返回 release_id 信息
  - (1.6.6) 推荐用户使用 fastlane gym build ipa文件 
